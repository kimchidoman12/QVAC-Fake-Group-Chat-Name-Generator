# QVAC Fake Group Chat Name Generator

Describe your friend group and an on-device AI invents a fitting group chat name, with a deterministic chaos meter.
...
Then open http://localhost:29423
